...
impl HealthCheck for SystemHealthCheck {
    fn check(&self) -> HealthComponent {
        HealthComponent::new("system", HealthStatus::Healthy).with_message("System is operational")
    }
}
...
impl HealthCheck for DatabaseHealthCheck {
    fn check(&self) -> HealthComponent {
        HealthComponent::new("database", HealthStatus::Healthy)
            .with_message("Database connection OK")
    }
}
...
impl HealthCheck for NetworkHealthCheck {
    fn check(&self) -> HealthComponent {
        HealthComponent::new("network", HealthStatus::Healthy)
            .with_message("Network connectivity OK")
    }
}
...
impl HealthCheck for CacheHealthCheck {
    fn check(&self) -> HealthComponent {
        HealthComponent::new("cache", HealthStatus::Healthy).with_message("Cache is operational")
    }
}
...
mod tests {
    ...
    fn test_health_checker() {
        ...
        checker.register(Box::new(SystemHealthCheck));
